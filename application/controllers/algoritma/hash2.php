	...
	public function hash($text)
    {
        switch ($this->hash) {
            ...
            case 'sha512/256':
                ...
                $key    = str_pad($this->key, 128, chr(0));     
                $temp   = $this->ipad ^ $this->key;             
                $temp  .= $text;                                 
                $temp   = self::_sha512($temp, $this->initial);   
                $output = $this->opad ^ $this->key;               
                $output.= $temp;                                  
                $output = self::_sha512($output, $this->initial);
