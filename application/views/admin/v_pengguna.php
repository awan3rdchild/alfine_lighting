            ...
            <table class="table table-bordered table-condensed" style="font-size:11px;" id="mydata">
                ...
                ?>
                    <tr>
                        ...
                        <td><?php if ($level=='1') echo 'Admin'; else echo 'Karyawan'?></td>
                        <td><?php if ($status=='1') echo 'Aktif'; else echo 'Nonaktif'?></td>
                        <td style="text-align:center;">
                            ...
                            <a class="btn btn-xs btn-danger" href="#modalHapusPelanggan<?php echo $id?>" data-toggle="modal" title="Hapus"><span class="fa fa-close"></span> Nonaktif</a>
                            <a class="btn btn-xs btn-success" href="#modalAktifPelanggan<?php echo $id?>" data-toggle="modal" title="Aktif"><span class="fa fa-check-square"></span> Aktif</a>
                        </td>
                    </tr>
                <?php endforeach;?>
                </tbody>
            ...
            <form class="form-horizontal" method="post" action="<?php echo base_url().'admin/pengguna/tambah_pengguna'?>">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-9">
                            <input name="no_hp" class="form-control" type="text" placeholder="Input No. Hp 08xx..." style="width:280px;" required>
                        </div>
                    </div>
        ...
        <?php
                ...
                <div id="modalEditPelanggan<?php echo $id?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
                    ...
                    <div class="form-group">
                        <label class="control-label col-xs-3" >No. Hp</label>
                        <div class="col-xs-9">
                            <input name="no_hp" class="form-control" type="text" value="<?php echo $no_hp;?>" placeholder="Input No. Hp 08xx..." style="width:280px;" required>
                        </div>
                    </div>
